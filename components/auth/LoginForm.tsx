            ...
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)} noValidate>
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" type="email" autoComplete="email" placeholder="Enter your email" aria-invalid={Boolean(errors.email)} className="h-12 border-slate-200 pl-11 pr-4 text-sm shadow-sm placeholder:text-slate-400 focus-visible:border-[#168d6e] focus-visible:ring-[#168d6e]/20" {...register("email", {
