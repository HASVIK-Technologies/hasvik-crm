              ...
              {items.map((item) => (
                <div key={item.id} className="flex items-start justify-between gap-3 rounded-2xl border border-[#eaf0f6] bg-white p-3 shadow-[0_2px_8px_rgba(20,40,60,0.02)] transition-all hover:border-[#0b63e5]/40 hover:shadow-md md:p-4">
                  <div className="flex min-w-0 items-start gap-3">
                    <Avatar className="mt-0.5 hidden size-11 shrink-0 rounded-full bg-[#e0eafe] text-sm font-bold text-[#2e90fa] sm:flex"><AvatarFallback className="bg-transparent text-inherit">{initials(item.businessName)}</AvatarFallback></Avatar>
